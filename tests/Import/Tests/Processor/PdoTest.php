...
namespace Import\Tests\Processor;

use Import\Processor\Pdo as PdoProcessor;
use Import\Row\Row;
 ...
 * @todo Test batching.
 */
class PdoTest extends ImportTestCase {
  ...
  protected function getMockPayload() {
    $payload = $this->getMock('\Import\Payload\ParsedPayloadInterface');
