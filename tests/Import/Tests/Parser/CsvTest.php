...
namespace Import\Tests\Parser;

use Import\Parser\Csv;
 ...
 * @todo Test batching.
 */
class CsvTest extends ImportTestCase {
  ...
  protected function getMockRawPayload($filepath) {
    $source = $this->getMock('\Import\Payload\RawPayloadInterface');
  ...
  public function testParse() {
    ...
    $this->assertInstanceOf('\Import\Payload\Csv', $result);
